...
def get_entrants_leaderboard(game_id):
    ...
    with db.engine().begin() as connection:
        entrants_leaderboard = connection.execute(sqlalchemy.text(""), {"game_id" : game_id}).mappings.fetchall()
...
def get_users_leaderboard(game_id):
    ...
    with db.engine().begin() as connection:
        users_leaderboard = connection.execute(sqlalchemy.text(""), {"game_id" : game_id}).mappings.fetchall()
